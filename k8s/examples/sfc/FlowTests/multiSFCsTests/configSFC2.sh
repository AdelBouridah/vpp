...
getPodNames() {
        ...
        rpcnf1=`kubectl get pods |  grep -oE "cnf1-sfc2\S*"`
	rpcnf2=`kubectl get pods |  grep -oE "cnf2-sfc2\S*"`
	rpcnf3=`kubectl get pods |  grep -oE "cnf3-sfc2\S*"`
	rpcnf4=`kubectl get pods |  grep -oE "cnf4-sfc2\S*"`
	rpcnf5=`kubectl get pods |  grep -oE "cnf5-sfc2\S*"`
}
