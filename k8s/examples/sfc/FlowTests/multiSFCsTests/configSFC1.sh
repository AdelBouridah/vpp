...
getPodNames() {
        ...
        rpcnf1=`kubectl get pods |  grep -oE "cnf1-sfc1\S*"`
	rpcnf2=`kubectl get pods |  grep -oE "cnf2-sfc1\S*"`
	rpcnf3=`kubectl get pods |  grep -oE "cnf3-sfc1\S*"`
	rpcnf4=`kubectl get pods |  grep -oE "cnf4-sfc1\S*"`
	rpcnf5=`kubectl get pods |  grep -oE "cnf5-sfc1\S*"`
}
