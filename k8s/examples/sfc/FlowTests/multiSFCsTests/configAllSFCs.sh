...
getPodNames() {
        ...
        rpcnf1=`kubectl get pods |  grep -oE "cnf1\S*"`
	rpcnf2=`kubectl get pods |  grep -oE "cnf2\S*"`
	rpcnf3=`kubectl get pods |  grep -oE "cnf3\S*"`
	rpcnf4=`kubectl get pods |  grep -oE "cnf4\S*"`
	rpcnf5=`kubectl get pods |  grep -oE "cnf5\S*"`
}
